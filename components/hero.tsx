  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center px-6 py-20 md:px-12 lg:px-20 overflow-hidden">
      ...
      <div className="relative z-[2] max-w-[780px]">
        <motion.h1
          className="font-serif text-5xl md:text-6xl lg:text-[80px] font-normal text-white leading-[1.08] tracking-tight"
        ...
        <motion.p
          className="text-[16px] md:text-[20px] text-white/85 leading-relaxed max-w-[520px] mt-6 mb-10"
        ...
        <motion.a
          href="#contact"
          className="inline-block bg-white text-primary px-9 py-4 rounded-sm font-semibold text-[16px] tracking-wide hover:-translate-y-0.5 hover:shadow-lg transition-all"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
