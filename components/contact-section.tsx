      ...
      <div className="mx-auto max-w-[1200px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          <AnimateOnScroll>
            ...
            <h2 className="font-serif text-3xl md:text-[44px] font-normal text-text leading-[1.2] mb-5">
              Ready to start walking?
            </h2>
            <p className="text-[16px] text-text-secondary leading-[1.7] mb-8">
              Tell us where you are and where you want to go. No pitch deck
              required. Just a conversation about what matters.
            </p>
