    ...
    <section id="outcomes" className="px-6 py-20 md:px-12 lg:px-20 lg:py-[120px]">
      <div className="mx-auto max-w-[1200px]">
        <AnimateOnScroll>
          ...
          <h2 className="font-serif text-3xl md:text-[48px] font-normal text-text leading-[1.2] max-w-[600px] mb-16">
          ...
          {outcomes.map((item, i) => (
            <AnimateOnScroll key={i} delay={i * 0.1}>
              <div className="bg-card border border-primary/10 rounded-lg p-6 md:p-10 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(26,22,20,0.06)]">
                <p className="text-[16px] font-medium text-primary mb-2.5">
                  {item.forLine}
                </p>
                <h3 className="font-serif text-xl md:text-[24px] font-medium text-text leading-[1.25] mb-3">
                  {item.headline}
                </h3>
